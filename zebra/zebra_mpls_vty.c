...
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 1, argv[0], NULL, argv[1], NULL, NULL,
                            NULL, NULL, argv[2]);
}
...
DEFUN (ip_route_tag_label,
       ...
       "One or more labels separated by '/'\n")
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 1, argv[0], NULL, argv[1], NULL, argv[2],
                            NULL, NULL, argv[3]);
}
...
DEFUN (ip_route_mask_label,
       ...
       "One or more labels separated by '/'\n")
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 1, argv[0], argv[1], argv[2], NULL, NULL,
                            NULL, NULL, argv[3]);
}
...
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 1, argv[0], argv[1], argv[2], NULL, argv[3],
                            NULL, NULL, argv[4]);
}
...
DEFUN (no_ip_route_label,
       ...
       "One or more labels separated by '/'\n")
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 0, argv[0], NULL, argv[1], NULL, NULL,
                            NULL, NULL, argv[2]);
}
...
DEFUN (no_ip_route_tag_label,
       ...
       "One or more labels separated by '/'\n")
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 0, argv[0], NULL, argv[1], NULL, argv[2],
                            NULL, NULL, argv[3]);
}
...
DEFUN (no_ip_route_mask_label,
       ...
       "One or more labels separated by '/'\n")
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 0, argv[0], argv[1], argv[2], NULL, NULL,
                            NULL, NULL, argv[3]);
}
...
DEFUN (no_ip_route_mask_tag_label,
       ...
       "One or more labels separated by '/'\n")
{
  return zebra_static_ipv4_safi (vty, SAFI_UNICAST, 0, argv[0], argv[1], argv[2], NULL, argv[3],
                            NULL, NULL, argv[4]);
}
